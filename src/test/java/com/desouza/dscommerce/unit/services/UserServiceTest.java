...
import com.desouza.dscommerce.tests.assertions.UserAssertions;
...
public class UserServiceTest {
    ...
    public void getMe_ShouldReturnUserDTO_WhenUserAuthenticated() {
        ...
        Assertions.assertNotNull(result);
        UserAssertions.assertDtoEquals(user, result);

        Mockito.verify(userRepository, times(0)).searchByEmail(user.getUsername());
    }
