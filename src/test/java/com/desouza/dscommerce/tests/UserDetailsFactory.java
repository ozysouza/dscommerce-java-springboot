...
public class UserDetailsFactory {
    ...
    public static List<UserDetailsProjection> createCustomAdminUser(String username) {
        ...
        list.add(new UserDetailsImpl(username, "123456781", 2L, "ROLE_ADMIN"));
    ...
    public static List<UserDetailsProjection> createCustomClientUser(String username) {
        List<UserDetailsProjection> list = new ArrayList<>();
        list.add(new UserDetailsImpl(username, "123456781", 1L, "ROLE_CLIENT"));
    ...
    public static List<UserDetailsProjection> createCustomAdminClientUser(String username) {
        List<UserDetailsProjection> list = new ArrayList<>();
        list.add(new UserDetailsImpl(username, "123456781", 1L, "ROLE_ADMIN"));
        list.add(new UserDetailsImpl(username, "123456781", 2L, "ROLE_CLIENT"));
